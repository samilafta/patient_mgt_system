                        ...
                        <div class="x_content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 profile_left">
                                    ...
                                    <a href="" class="btn btn-success" data-toggle="modal" data-target="#editModal"><i class="fa fa-edit"></i> Edit Patient Info</a>

                                    <!-- editmodal start -->

                                    <?php
                                    $puid =$row['patientUniqueID'];
                            ...
                            <!-- add new medical record of patient -->
                            <form method="post" action="val/addappointment.php" style="margin: 10px;">
                                <input type="hidden" name="puid" value="<?php echo $row['patientUniqueID'] ?>" />
                                <input type="hidden" name="pid" value="<?php echo $pid ?>"/>

                                <button name="addapp" class="btn btn-primary bg-blue-sky">
                                    <i class="fa fa-plus"></i> Create New  Medical Record
                                </button>
                            </form>
                    </div>
                </div>
